...
face_vec_time = vector()
face_vec_date = vector()
i = 1
while (i<8-min(as.POSIXlt(data$Date))$wday) {
	face_vec_date <- c(face_vec_date, 'plain')
	face_vec_time <- c(face_vec_time, c('plain', 'plain'))
	i = i+1
}
