...
expanding <- expand.grid(Date =unique(data3$Date), User= unique(data3$User), Time=unique(data3$Time))
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.width= 10}
ggplot(data, aes(User, Price)) + geom_boxplot(fill='#A4A4A4', color="black")
```
